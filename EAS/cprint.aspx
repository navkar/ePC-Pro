 ...
 -->
	...
	<body>
		<form id="iDOC" runat="server">
			...
			<BR>
			<div align="center">
				<asp:RadioButtonList AutoPostBack="False" ID="listFiles" Runat="server" CellPadding="2" CellSpacing="0" RepeatDirection="Vertical" RepeatColumns="1" RepeatLayout="Table" Font-Name="Verdana" Font-Size="9pt" Font-Bold="true" BackColor="Beige" BorderWidth="2" ForeColor="DarkSlateBlue" BorderStyle="Solid" BorderColor="Tan"></asp:RadioButtonList>
				<BR>
				...
				<table border="0" CellPadding="2" CellSpacing="0" Width="100%">
					...
					<tr>
						<td>
							<asp:HyperLink runat="server" id="docLink" Font-Name="Verdana" Font-Italic="false" Font-Size="Smaller" NavigateUrl="cjob.aspx" Text="iPrint Job Box Page" />
						</td>
					</tr>
				</table>
			</div>
