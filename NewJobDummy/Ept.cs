...
namespace EPTDummy
{
	...
	public class EPrinterDummy : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(EPrinterDummy));
			...
			this.Text = "New Job(NWJ) Request Dummy";
		...
		{
			string strRequest = txtAreaRequest.Text;
...
*/	
				...
				BinaryWriter bw = new BinaryWriter(fs);
							bw.Write(RecvBytes, 0, totalBytes);
							bw.Flush();
							bw.Close();
